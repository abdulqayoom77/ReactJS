...
const Hero = () => {
  ...
  return (
    <div className="h-[100vh] w-[100vw] flex justify-center items-center flex-col gap-8 bg-gradient-to-b from-black via-black to-gray-900 text-center pt-10 lg:pt-5 md:pt-5" >
      <h1 className="text-4xl lg:text-7xl md:text-5xl font-bold bg-gradient-to-r from-[#535353] to-[#d3d3d3] bg-clip-text text-transparent bg-clip-text cursor-pointer overflow-y-hidden"  >
        Front-End Developer
      </h1>
      <h2 className="text-gray-400 bg-clip-text cursor-pointer overflow-y-hidden w-[75vw] md:w-[50vw] lg:w-[50vw] text-center  text-sm md:text-2xl lg:text-2xl">
